...
invariants are load-bearing — see §3. Do not weaken them without the user
explicitly asking.
...
## 3. Integrity invariants — DO NOT break these
...
1. **Understand:** read the touched `internal/` package and check §3 invariants.
